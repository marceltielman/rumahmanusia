...
@Component({
  ...
  template: `
    <div style="max-width:1120px;margin:0 auto;background:var(--color-band);color:#ffffff;border-radius:28px">
      <div style="max-width:1120px;margin:0 auto;padding:clamp(44px,6vw,88px) clamp(24px,4vw,40px);display:flex;gap:40px;justify-content:space-between;align-items:flex-end;flex-wrap:wrap">
        ...
        <div style="display:flex;gap:12px;flex-wrap:wrap">
          <a class="btn" href="#contact" style="background:#ffffff;color:var(--color-band-ink)">{{ site.cta }}</a>
