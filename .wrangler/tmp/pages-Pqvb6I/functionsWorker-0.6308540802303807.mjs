...
async function onRequestPost(context2) {
  ...
  const reply = /* @__PURE__ */ __name((status, ok, message) => wantsJson ? Response.json({ ok, message }, { status }) : htmlResponse(status, ok, message), "reply");
  try {
...
function htmlResponse(status, ok, message) {
  const escape = /* @__PURE__ */ __name((s) => s.replace(/[&<>"]/g, (c) => ({ "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;" })[c]), "escape");
  return new Response(
    `<!DOCTYPE html>
...
// ../.wrangler/tmp/pages-Pqvb6I/functionsRoutes-0.7901647144121505.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-k5kV5x/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-k5kV5x/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.6308540802303807.mjs.map
